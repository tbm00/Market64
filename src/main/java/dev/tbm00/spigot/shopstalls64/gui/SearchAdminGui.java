...
import dev.tbm00.spigot.shopstalls64.utils.ShopUtils;

public class SearchAdminGui {
    
    /**
     * Creates an anvil gui for player to enter text and search shops with.
     */
    public SearchAdminGui(ShopStalls64 javaPlugin, Player player) {
        ...
        new AnvilGUI.Builder()
            .onClick((slot, stateSnapshot) -> {
                ...
                return Arrays.asList(
                    ...
                    AnvilGUI.ResponseAction.run(() -> ShopUtils.handleAdminSearch(player, arr))
                );
            })
            .text(" ")
            .itemLeft(leftItem)
